...
class SuratmasukController extends Controller
{
    ...
    //function untuk tambah
     public function tambah (Request $request)
     {
        ...
        $suratmasuk->save();
        return redirect('/suratmasuk/index')->with("sukses", "Data Event Masuk Berhasil Ditambahkan");
    ...
    public function update (Request $request, $id_suratmasuk)
    {
        ...
        return redirect('suratmasuk/index') ->with('sukses','Data Event Masuk Berhasil Diedit');
    }
    ...
    public function delete($id_suratmasuk)
    {
        $suratmasuk=\App\SuratMasuk::find($id_suratmasuk);
        $suratmasuk->delete();
        return redirect('suratmasuk/index')->with('sukses','Data Event Masuk Berhasil Dihapus');
    }
