...
class SuratKeluarController extends Controller
{
    ...
    public function tambah (Request $request)
    {
       ...
       $suratkeluar->save();
       return redirect('/suratkeluar/index')->with("sukses", "Data Event Keluar Berhasil Ditambahkan");
    }
    ...
    public function update (Request $request, $id_suratkeluar)
    {
        ...
        return redirect('suratkeluar/index') ->with('sukses','Data Event Keluar Berhasil Diedit');
    }
    ...
    public function delete($id_suratkeluar)
    {
        $suratkeluar=\App\SuratKeluar::find($id_suratkeluar);
        $suratkeluar->delete();
        return redirect('suratkeluar/index') ->with('sukses','Data Event Keluar Berhasil Dihapus');
    }
