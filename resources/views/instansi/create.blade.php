    ...
    <div class="box">
        ...
        <form action="{{ route('instansi.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <input name="pimpinan" type="text" class="form-control bg-light" id="pimpinan" placeholder="Nomor Telepon" oninput="this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1')" required>
