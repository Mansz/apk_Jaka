...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(to right, #FFFFFF,  #007BA7);
        }
...
<body>
    <div class="kotak_login">
        ...
        @endif
        <img src="/picture3.png" alt="Logo" class="logo">
        <br>
        <h2 class="font-weight-bold text-center">Sistem Jadwal Kalender</h2>
