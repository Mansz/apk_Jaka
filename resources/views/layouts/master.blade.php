...
<head>
    ...
    <style>
        /* Mencegah penggunaan geser kanan kiri pada perangkat mobile */
        html, body {
            overflow-x: hidden;
        }
    </style>
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <h3 class="font-weight-bold d-none d-lg-block">SISTEM JADWAL KALENDER</h3>
            </ul>
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-1">
            ...
            <div class="sidebar">
                ...
                <img src="/picture3.png" alt="Logo" class="logo" style="width: 80px; height: auto;">
                    <div></div><br>
                </div>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="/suratmasuk/agenda" class="nav-link">
                                        <i class="fas fa-calendar"></i>
                                        <p>Agenda Event Masuk</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="/suratkeluar/agenda" class="nav-link">
                                        <i class="fas fa-calendar"></i>
                                        <p>Agenda Event Keluar</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
        ...
        <footer class="main-footer" style="text-align: center;">
            Development &copy; 2024.pusatdata.id
        </footer>
